...
\end{equation}
%
which is the \ndef{Liouville’s Theorem} in the relativistic case. 
%
...
%
\todo{
    Note that I still have no Idea what I have written. 
    I need to go through the original materal, which I could not find... 
    at least I could not find what I could read and understand. 
}
...
\end{equation}
%
where $F$ is \ndef{invariant distribution function}, 
...
In order to derive from the Boltzmann equation the equations of hydrodynamics, 
...
\todo{this is not clear how it was obtain. Must go through again.}
%
\begin{equation}that
...
distribution function $F$ \citeз{Cercignani:2002}, and thus the form of the stress-energy tenor. 
...
\end{equation}
%
\todo{check the sources. Write intermediate steps}
%
