...
Euler equations.
One of the way how the Euler equation can be derived is by considering the 
...
For the sake of completeness, however, we provide the key steps of the derivation, in Appendix~\ref{app:eul}.
