...
and the key steps in deriving the Hamiltonian formulation of \ac{EFE}, 
in the Appendix~\ref{app:adm}.





Next we proceed with obtaining the Hamiltonian formulation of \ac{EFE}.
For the sake of brevity, we omit the derivation itself. 
The main stages of the derivation are presented in Appendix~\ref{app:adm}.
%
...
%
A class of slicing conditions in form of hyperbolic equations that are more favorable from numerical standpoint and that reproduces the desired behavior of the maximal slicing was proposed in \citet{Bona:1994dr}. 
%
It reads 
%
\begin{equation}
