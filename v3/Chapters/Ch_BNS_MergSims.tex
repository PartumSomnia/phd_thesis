...
The evolution of \ac{BNS} systems is performed with \wisky{} \ac{NR} code
 \cite{Radice:2013apa,Radice:2012cu,Radice:2013xpa,Radice:2013hxh,
...
with sub-cycling in time and refluxing. %\textcolor{red}{in Thesis it is said, -- no refluxing was done yet}
...
showed that the angular velocity profiles becomes approximately Keplerian at this point  \citep[\eg][]{Shibata:2005ss,Shibata:2006nm,Hanauske:2016gia,Kastaun:2016elu}.
...
%are quasiradial mode $F$ ($m=0$), the $m=2$ $f$-model and non-linear combinations of them \citep[\eg][]{Shibata:2000jt,Stergioulas:2011gd}.
%
