...
As we discussed above, the the interaction between the \ac{MNS} remnant and the disk 
...
have considered, it enhances the DD2 \ac{SWW} mass by ${\sim}25$\%. \red{Letter stuff. Not sure if true}
...
appears to be stronger, as the stiffer \ac{EOS} leads to a more massive disk  % contradiction with [1]
