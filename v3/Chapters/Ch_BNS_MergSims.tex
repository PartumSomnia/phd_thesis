...
For instance, for the model with $q=1.00$ and \ac{BLh} \ac{EOS}, 
...
the figure). \red{define the green line here}
...
\begin{figure*}
    \centering 
    \includegraphics[width=0.329\textwidth]{./figs/fast_ejecta/BLh_q100_LK_SR.pdf}
    \includegraphics[width=0.329\textwidth]{./figs/fast_ejecta/SFHo_q100_LK_SR.pdf}
    \includegraphics[width=0.329\textwidth]{./figs/fast_ejecta/SFHo_q112_LK_SR.pdf}
...
\begin{figure}%%[t]
    \centering 
    \includegraphics[width=0.49\textwidth]{./figs/scatter_ekej_vej06.pdf}
    \includegraphics[width=0.49\textwidth]{./figs/\textsc{scatter_thetarms_vej06.pdf}}
    %% \includegraphics[width=0.49\textwidth]{./figs/scatter_lambda_ekej_vej06.pdf}
    %% \includegraphics[width=0.49\textwidth]{./figs/scatter_mej_vej06.pdf}
    %% \includegraphics[width=0.49\textwidth]{./figs/scatter_total_kinetic_energy.pdf}
    %%     \includegraphics[width=0.49\textwidth]{./figs/scatter_thetarms_vej06.pdf}
...
\begin{figure}%%[t]
    \centering 
    \includegraphics[width=0.49\textwidth]{./figs/\textsc{\textsc{kinetic_energy_struct_models.pdf}}}
    \caption{
