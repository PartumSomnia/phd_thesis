...
of the numerical setups are further discussed in Appendix~\ref{app:whisky}.
...
\begin{figure}[t]
    \centering 
    \includegraphics[width=0.30\textwidth]{ejecta_postdyn/wind_mass_flux.pdf}
...
\begin{figure*}[t]
    \centering 
    \includegraphics[width=0.75\textwidth]{ejecta_postdyn/wind_hists_shared.pdf}
