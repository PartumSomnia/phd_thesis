...
\section{Neutron Star Equations of State}\label{sec:theory:eos}
...
\section{Neutrino Radiation Transport}\label{sec:theory:neut}
...
\section{Effects of magnetic fields}\label{sec:theory:visc}
