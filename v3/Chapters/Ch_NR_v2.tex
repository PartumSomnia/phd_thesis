...
In this thesis we exclusively focus on microphysical \acp{EOS} with finite-temperature effects.
These \acp{EOS} are constructed from the quantum field theory based on the stat-of-the-art
