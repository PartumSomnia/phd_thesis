...
\chapter{BNS ejecta and disk mass statistics} % Main chapter title
...
As the errors for ejecta quantities are not available for most datasets, 
...
%to verify our approach. %%% NO WE DON'T DO IT HERE!!! 
%
...
%Fig.~\ref{fig:ejecta:dyn:ds} for all datasets. 
%We note that the overall properties of the 
...
The inclusion of models with neutrino cooling only, \DScool{}, 
...
\begin{figure}[t!]
    \centering 
    \includegraphics[width=0.65\textwidth]{statistics/parspace_mej_m0m1.pdf}
    \includegraphics[width=0.65\textwidth]{statistics/parspace_mej_all.pdf}
    \caption{
...
\begin{figure}[t!]
    \centering 
    \includegraphics[width=0.65\textwidth]{statistics/residuals_sets_mej.pdf}
    \caption{
...
%thus less favorable by the $\chid$ analysis. 
...
\DSrefset{} \& \DSheatcool{} or all available models are considered in  Fig.~\ref{fig:mej_parspace}. % on the left and right panels respectively. 
...
reproduce the $\amd$ of \DScool{} models. % with the leakage neutrino scheme employed.
%
...
%\red{This paragraph is not approved at the time of writing}
Overall we conclude that the intrinsic scatter in data hinders the performance 
...
The average of the mass-averaged ejecta velocity, $\avd$, 
...
%which as
%displayed in Fig.~\ref{fig:ejecta:dyn:ds}, are the models with the highest $\avd$.

%% VELOCITY 
\begin{figure}[t!]
    \centering 
    \includegraphics[width=0.65\textwidth]{statistics/residuals_sets_vej.pdf}
    \caption{
...
\begin{figure}[t!]
    \centering 
    \includegraphics[width=0.65\textwidth]{statistics/residuals_sets_yeej.pdf}
    \caption{
...
As fitting formulae we consider only the polynomials, Eq.~\eqref{eq:polyfit2}-\eqref{eq:polyfit22}. 
...
%Indeed, the $\ayd$ of models with only leakage scheme 
%is systematically different from that of \DSheatcool{} and \DSrefset{} 
...
\begin{figure}[t!]
    \centering 
    \includegraphics[width=0.65\textwidth]{statistics/residual_sets_thetaej.pdf}
    \caption{
...
We find that $P_2^2(q,\tilde\Lambda)$ performs significantly better than one-parameter 
...
long-lived remnants.
%we find that the minimum value in models that produce a \ac{BH}, and is $0.01\,\Msun$, in models that produce a \ac{BH}, and the maximum value, $0.3\,\Msun$, 
...
%
If we add models of the \DSnone{}, the mean value %as disk masses 
...
\begin{figure}[t!]
    \centering 
    \includegraphics[width=0.65\textwidth]{statistics/parspace_mdisk_m0m1.pdf}
    \includegraphics[width=0.65\textwidth]{statistics/parspace_mdisk_all.pdf}
    \caption{
...
\begin{figure}[t!]
    \centering 
    \includegraphics[width=0.65\textwidth]{statistics/residuals_sets_disk_mass.pdf}
    \caption{
        ...
        %        four fitting formulae (one per subpanel) and for four different 
        %        calibration sets (different markers) that correspond to four 
        %        entries in the Tab.~\ref{tab:DiskFitchi2}. 
        %        %
        %        Here $\Delta M_{\rm disk} = M_{\rm disk} - M^{\rm fit}_{\rm disk}$.
        %        %
        %        From top to bottom the subpanels arranged based on the relative 
        %        performace of the fitting formula, with \polql{} being the best one.
...
\input{Tables/tabRedChi2Disk.tex} 
%% -------------------------------------------------------------
...
%\red{Not approved paragraph}
The values of $M_{\text{disk}}$ from datasets alongside the values predicted by $P_2^2(q,\tilde{\Lambda})$ (colored contours) are shown in Fig.~\ref{fig:mdisk_parspace}.
