...
\citep{Banyuls:1997} was implemented. 
%
...
%
$\Mmax$ and $R_{1.4}$ are related to the pressure at half saturation density \citep{Lattimer:2012nd}.
This motivates the naming convention, that we have already introduced 
for \acp{EOS}. Those that lead to \acp{NS} with smaller 
...
%
These observations highlight the importance of using \acp{EOS} with finite-temperature effects. 
...
With methods discussed in this chapter, incorporated in 
the \ac{GRHD} code \wisky{} a a large set of \ac{BNS} merger 
simulations was performed. We summarize their properties in the
Tab.~\ref{tab:sim}. 
%
