...
\section{Neutron star equation of state}\label{sec:nr_methods:eos}
...
Most commonly used approaches to simplify the radiation transport rely 
...
(fluid's pressure gradient, internal energy and heating) %(\eg, due to an $r$-process (\red{see section XXX})) 
