...
\ac{EM} counterparts.
%
This section is based on the recent reviews done by 
...
%%%% DYNAMICAL EJECTA
Tidal interactions and shocks exerted on the \acp{NS} at merger trigger the 
...
induced by neutrino heating above the remnant, are expected to contribute to the 
mass and angular momentum loss. 
%
Moreover, the matter outflow could be further enhanced by the magnetic stresses 
...
peaking on a timescale of around a few days. 
%
...
lanthanides $(58\leq Z \leq71)$ and actinides $(90\leq Z \leq 103)$, are present 
due to their open $f$-shell and, thus, a plethora of 
absorption lines \citep{Tanaka:2013ana,Kasen:2013xka}.
%
The properties and geometry of different \ac{BNS} merger ejecta 
that have various optical opacities and heating rates, 
determining the \ac{kN}, emission \citep{Metzger:2019zeh}.
%
...
%secular ejecta. 
Semi-analytic two-components (red and blue) spherical \ac{kN} models to 
...
The outflow properties inferred for \AT{} using multi-componentsm semi-analytic and 
...
%% ---
The additional challenge, is to reproduce the early blue emission. 
