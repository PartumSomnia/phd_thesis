...
\begin{titlepage}
    \begin{center}
        ...
        \vspace{5mm}
        \huge 
        \textbf{Binary Neutron Star Merger Simulations:}\\
        \large
...
%    \vspace{0.9cm}
    ...
    of matter at densities exceeding those found in nuclei. Such conditions are 
    ...
    surroundings with very heavy elements, but are they a dominant source of these elements?
    ...
    comparing them to abundances found in solar system. 
    and investigate the \ac{EM} emission, powered by the decay of newly synthesized heavy elements, 
    comparing it to observations. 
    Finally, we investigate the long-term emission of the ejected 
    material as it propagates through \ac{ISM}, via our own numerical tools, 
...
\dedicatory{I dedicate this work to my parents, whose love and support have never abandoned me} 
