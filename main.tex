...
It has been shown, that the ADM system of equations in its original form (\ref{eq:theory:adm}) is only weekly hyperbolic \cite{Baumgarte:2002jma}. It was shown that in such system the errors tend to couple with zero-velocity modes \cite{Alcubierre:1999rt}.  \\
...
The Z4 formulation is derived using the Palatini-type variational principle \cite{Bona:2010is}. The result are the field equations 
...
where the latter is called an algebraic constraint 
