...
\chapter{Finite-Dierencing Methods: Flat Spacetimes}

\section{Introduction}

To increase a formal order of accuracty in a current generation numerical codes, the use of flux-conservative finite-difference HRSC schemes is the simplest approach. Its direct competitior, high-order finite volume schemes are more computationally expensive, as they require solution of multiple Riemann problems at the interface between regions 
