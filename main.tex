...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        The complications however are present when the source terms are treated. While for a simplified case of classical gass dynamics it might require a lower timestep, in the general relativistic case and general taulated EOS, the positivist of pressure is difficult to assure. This can be metigated by enforcing a floor value on the pressure 
