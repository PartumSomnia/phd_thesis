...
for numerical reasons we define the difference between the total internal energy density and the rest-mass density, $\tau = E-D$


[130]\cite{Font:2008fka} [36]\cite{Banyuls:1997} [210]\cite{Marti:1991wi} [146]\cite{Giacomazzo:2010bx} [274]\cite{Rezzolla:2011da} [248]\cite{Papadopoulos:1999kt} [275]\cite{Rezzolla:2013}
