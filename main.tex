...
A central scheme, is a scheme that does not require any Reimann solver. The first such scheme was proposed by Lax and Friedrichs (LxF) 

Let us consider monotone schemes. 

The first one, albeit with much higher numerical dissipation then the Godunov scheme but having an advantage of 
