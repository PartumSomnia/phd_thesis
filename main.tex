...
where $M_{ej}$ and $\upsilon_{ej}$ are the mass and characteristic velocity of the ejected material, $\kappa$ is its opacity, $c$ is the speed of light, and $\dot{E_{\text{rad}}$ is the time-dependent rate of energy generation by radioactive decay. 
