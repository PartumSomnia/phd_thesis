...
The ejecta composition is important to determine its thermolisation. Not only it defines the background material, that affects the decay products energy loss, but it also sets the distribution of thadiactive energy between various decay channels and energy spectra of the decay products. 

The composition (on a set of smooth-particle hydrodynamic trajectories \cite{(Goriely et al. 2011)}) is computed from the the $r$-process nucleosynthesis, that is tracked via nueclear reaction network \cite{Mendoza-Temis et al. 2015}. The network starts with matter in NSE, at $T\sim6$~GK, densitites from HD histories and initial electron fractions $0.015-0.055$. 
