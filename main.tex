...
\magneta{Broadband lightcurves} shows that $r$-process material, its high opacity, leads to the suprerssion of the emission in optical band, while most of the eneregy is located at IR and FIR bands. In addition, the emission at high freuqncy bands, U, B, V is suppressed due to strong line-blanketing and lightcurves decay rapidly with time. This behaviour stems from the evolution of photospheric properties of $r$-process transiets, assuming that the observed SED roughly corresponds to a blackbody at the photospheric temperature and radius.
