...
A more physically motivated approximation of the radiation transport can be achieved via expending the radiation intensity in angles using spherical harmonic basis functions. This is so-called $P_N$ method. It allows to convert the integrodifferential equation into a hyperbolic system of partial differential equations for the expansion coefficients. The coefficients stand for angualr moments in the basisi of spherical harmonic functions. 
