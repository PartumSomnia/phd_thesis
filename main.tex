...
\red{On the lanthanaid production, opacities and kilonova of BNS ejecta}

\subsection{Introduction}
\red{Motiviation for Nucleosynthesis for Kilonova}

Neutron star mergers (BNS) or neutron star-black hole mergers (NSBH) lead to the emission of graviational waves \cite{(LIGO Scientific Collaboration et al., 2015)} and ejection of mass via dynamical processes \cite{Lattimer et al., 1977}. They also power short gamma-ray bursts (sGRB) (\textit{e.g.,} Lee and Ramirez-Ruiz, 2007; Nakar, 2007; Gehrels et al.,
...
In the neutron-rich material ejected during the merger, the $r$-process nucleosynthesis took place, creating heavy, up to $A\sim 300$, nuclides, that subsequently decayed into the valley of stability after the neutron capture has ceased, (see, \textit{e.g.,} \cite{Burbidge et al., 1957} for the process description). 

BNS and NSBH mergers are one of the prime sources of the $r$-process elements in the Universe \cite{Argast et al., 2004; Shen et al., 2015; van de Voort et al., 2015; Ramirez-Ruiz et al., 2015}, 

\gray{The ejecta material, interaction with interstellar medium (ISM) results in an additional electromagnetic counterpart in primaraly, radio bnand, on a timescale of a few weeks. \cite{Nakar and Piran, 2011} }

The radioactive decay of unstable nuclides formed during decompression of the ejecta releases enough energy to power an electromagnetic transient in optical and near infrared, that peaks on a timescale from hours to a week \cite{(Li and Paczynski, 1998; Kulkarni, 2005; Metzger et al., 2010; Kasen et al., 2013; Tanaka and Hotokezaka, 2013}. This transient is called "kilonova" \cite{Metzger et al., 2010} or "macronova" \cite{Kulkarni, 2005}. 
Such transients were suspected for the events of gamma-ray bursts, GRB130603B \cite{Tanvir et al., 2013; Berger et al., 2013} and GRB060614 \cite{Yang et al., 2015; Jin et al., 201} as an excess in infrared afterglow, that is an indication of a $r$-process material decay. \red{In 2017 the Kilonova was directly observed, following the gravitational wave signal from merging neutron stars}. \red{[REFS]} 

The composition of the ejecta, that eventually determines properties of the electromagnetic signale, depends on the ejection mechanism. In case of dynamical ejecta, two components are usually considered, the material that is ejected tidally and \cite{Lattimer et al., 1977; Freiburghaus et al., 1999} and the material that is ejected by shocks from the region where neutron stars touch, the shocked component \cite{Bauswein et al., 2013; Hotokezaka et al., 2013b}. On a longer timescale, if a disk is formed around the remnant, the wind from this disk represents an additional ejecta \cite{Fernandez and Metzger, 2013; Perego et al., 2014; Just  et al., 2015}.
The electron fraction of the ejecta depends on the weak interations, in particluar on the weak interaction timescale relative to the dynamical timescale.
Thus, the tidal component of the dynamical ejecta would have low electron fraction \cite{Korobkin et al., 2012}, the wind from the disk, irradiated by the neutrinos and heated up by shocks would have high $Y_e$ \cite{Just et al., 2015; Richers et al., 2015} and the shocked component of the dynamical ejecta would take an intermediate value, depending on the energetics of the collision \cite{Wanajo et al., 2014; Goriely et al., 2015}. 
%
For the material with initial electron fraction $Y_e\leq 0.2$ the fission cycling in a strong $r$-process makes final composition rather independent of the exact value of $Y_e$ \cite{Metzger et al., 2010; Roberts et al., 2011; Goriely et al., 2011}. If the $Y_e\in[0.2,0.3]$, however, the final composition of the outflow depends on the details of the incoplete $r$-process nucleosynthesis \cite{Korobkin et al., 2012; Grossman et al., 2014; Kasen et al., 2015}

The energy that powers an electromagnetic transiet comes from the decay of heavy elements primarely, as the aduabatic expansion of the outrlow efficiently removes its initial (kinetic) energy \cite{Metzger et al., 2010}. This the composition of the ouflow at $\sim 1$~day, as well as mass and velocity, sets the nueclar heating rate and opacity of the material \cite{Li and Paczynski, 1998}. 
%Thus, the kilonova peak time and luminocity depends on the ejecta composition. 

It was shown that the presence of elements synthesisied in $r$-process, \textit{e.g.,} lanthanides and actinides can significnaly alter the material photon opacity 
\cite{Kasen et al., 2013 and Tanaka and Hotokezaka, 2013}. This is becase these atoms are complex with a number of possible transition exceeding that of iron-group elements. As the time of the peak of the transient depends on when the material becoms tranparent, the presence and the exact amount of lanthanides and actinides can change the observe properties of the kilonva drastically \cite{Barnes and Kasen, 2013; Tanaka and Hotokezaka, 2013}. 
Thus, accurate modelling of the composition of the outflow is of prime importance for predicting the electromagnetic counterparts to mergers. 

\gray{In this work we we present a parameter study of detailed nucleosynthesis calculations in NSBH or NSNS merger scenarios}
